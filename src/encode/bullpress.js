...
console.log("Size Difference:  ", encodedString.length - originalString.length, "bytes")
console.log("Percentage Difference:  ", ((encodedString.length - originalString.length) / originalString.length * 100).toFixed(2), "%")
console.log()
