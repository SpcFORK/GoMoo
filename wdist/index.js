(() => {
  ...
  var require_cst = __commonJS({
    "src/encode/bullpress/blocks/cst.js"(exports, module) {
      var CHUNK_LENGTH2 = 1024 * 8;
      var CHUCK_LENGTH_SPEED2 = 270;
      var CHAR_EXCHANGE_COST2 = CHUCK_LENGTH_SPEED2 / CHUNK_LENGTH2;
      function calculateCost2(string) {
        return string.length * CHAR_EXCHANGE_COST2;
      }
      ...
      var eobj = {
        ...
        CHUCK_LENGTH_SPEED: CHUCK_LENGTH_SPEED2,
        CHAR_EXCHANGE_COST: CHAR_EXCHANGE_COST2,
  ...
  var require_casing = __commonJS({
    "src/encode/bullpress/blocks/casing.js"(exports, module) {
      var eobj = {
  ...
  var require_avoidE = __commonJS({
    "src/encode/bullpress/blocks/avoidE.js"(exports, module) {
      var eobj = {
        encode(input) {
          const caser = (_) => `(${_})`;
  ...
  var require_bracketE = __commonJS({
    "src/encode/bullpress/blocks/bracketE.js"(exports, module) {
      var eobj = {
        encode(input) {
  ...
  var require_base64 = __commonJS({
    "src/encode/bullpress/blocks/base64.js"(exports, module) {
      var base642 = {
      ...
      if (typeof globalThis.Buffer !== "undefined")
        ...
        module.exports = base642;
    }
  });

  // src/encode/bullpress/bullpressWeb/bullpress.web.js
  function encodeBullpress(input, chunkSize = import_cst.CHUNK_LENGTH) {
    let encodedResult = "";
    for (let i2 = 0; i2 < input.length; i2 += chunkSize) {
      let chunk = input.substring(i2, Math.min(i2 + chunkSize, input.length)), basedKey = import_base64.default.encode(chunk), res1 = import_BWT.default.burrowsWheelerTransform(basedKey), numbedKey = import_avoidE.default.encode(res1.transformedString), transformedString = import_cowrle.default.encodeCOWRLE(numbedKey);
      encodedResult += import_casing.default.caseChunk({
        transformedString,
        originalIndex: res1.originalIndex
      });
    }
    return import_casing.default.caseBull({
      chunk: encodedResult
    });
  }
  function decodeBullpress(input) {
    ...
    for (let i2 = 0; i2 < decodedResult.length; i2++) {
      const chunk = decodedResult[i2];
      const [, transformedString, originalIndex] = chunk.match(
        /<Bull_Chunk:(.*)\|(\d+):>/
      );
      const numbedKey = import_cowrle.default.decodeCOWRLE(transformedString);
      const res1 = import_avoidE.default.decode(numbedKey);
      const basedKey = import_BWT.default.inverseBurrowsWheelerTransform(res1, originalIndex);
      output += import_base64.default.decode(basedKey);
    }
    return output;
  }
  var import_cowrle, import_BWT, import_huffman, import_cst, import_casing, import_avoidE, import_bracketE, import_base64;
  var init_bullpress_web = __esm({
    "src/encode/bullpress/bullpressWeb/bullpress.web.js"() {
      import_cowrle = __toESM(require_cowrle());
      import_BWT = __toESM(require_BWT());
      import_huffman = __toESM(require_huffman());
      import_cst = __toESM(require_cst());
      import_casing = __toESM(require_casing());
      import_avoidE = __toESM(require_avoidE());
      import_bracketE = __toESM(require_bracketE());
      import_base64 = __toESM(require_base64());
    }
  });

  // src/encode/bullpress/bullpressWeb/index.js
  var require_bullpressWeb = __commonJS({
    "src/encode/bullpress/bullpressWeb/index.js"(exports, module) {
      init_bullpress_web();
      function encode(input, logging = false) {
        ...
        {
          logIfEnabled("Encode COST:    ", (0, import_cst.calculateCost)(uriString));
        }
        if (input.length < 1e3) {
        ...
        const encodedString = encodeBullpress(uriString), isOptimized = encodedString.length < uriString.length, chunkCount = (0, import_cst.calculateChunks)(uriString);
        {
          logIfEnabled(
            "Encoded String:   ",
        ...
        return {
          ...
          timeSpent,
          chunkCount,
          presumedTime: (0, import_cst.calculateCost)(uriString).toFixed(2)
        };
      }
      ...
      function decode(input, logging = false) {
        ...
        const start = Date.now(), decodedString = decodeBullpress(input), chunkCount = (0, import_cst.calculateChunks)(decodedString);
        {
          logIfEnabled(
            "Decoded String:   ",
      ...
      function processEncoding(input, logging = false) {
        ...
        logIfEnabled(".-- Doing Logs... --.\n");
        {
          ...
          logIfEnabled();
          logIfEnabled("Chunk Length:   ", import_cst.CHUNK_LENGTH, "bytes");
          logIfEnabled(
      ...
      var eobj = {
        ...
        // @ Other exports
        CHUNK_LENGTH: import_cst.CHUNK_LENGTH,
        calculateCost: import_cst.calculateCost,
        calculateChunks: import_cst.calculateChunks
      };
      if (typeof globalThis.window !== "undefined")
